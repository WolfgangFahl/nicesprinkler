...
from sprinkler.sprinkler_config import SprinklerConfig, Angles, Hose, Lawn, AngleRange,Motor, Motors, SprinklerHead
import json
...
class TestSprinklerConfig(SprinklerBasetest):
    ...
    def test_config_loading(self):
        ...
        if self.debug:
            for part in [self.config.lawn, self.config.sprinkler_head,self.config.angles.horizontal,self.config.angles.vertical,self.config.hose,self.config.motors]:
        ...
        self.assertListEqual(self.config.angles.horizontal.angles,
                             [-85.0, -83.0, -81.0, -79.0, -77.0, -75.0, -73.0, -71.0, -69.0, -67.0,
                              -65.0, -63.0, -61.0, -59.0, -57.0, -55.0, -53.0, -51.0, -49.0, -47.0,
                              ...
                              19.0, 21.0, 23.0, 25.0, 27.0, 29.0, 31.0, 33.0, 35.0, 37.0, 39.0,
                              41.0, 43.0, 45.0, 47.0, 49.0, 51.0, 53.0, 55.0, 57.0, 59.0, 61.0,
                              63.0, 65.0, 67.0, 69.0, 71.0, 73.0, 75.0, 77.0, 79.0, 81.0, 83.0, 85.0])
        ...
        self.assertListEqual(self.config.angles.vertical.angles,
                             [-75.0, -73.0, -71.0, -69.0, -67.0, -65.0, -63.0, -61.0, -59.0, -57.0,
                              -55.0, -53.0, -51.0, -49.0, -47.0, -45.0, -43.0, -41.0, -39.0, -37.0,
                              -35.0, -33.0, -31.0, -29.0, -27.0, -25.0, -23.0, -21.0, -19.0, -17.0,
                              -15.0, -13.0, -11.0, -9.0, -7.0, -5.0, -3.0, -1.0, 1.0, 3.0, 5.0, 7.0,
                              9.0, 11.0, 13.0, 15.0, 17.0, 19.0, 21.0, 23.0, 25.0, 27.0, 29.0, 31.0,
                              33.0, 35.0, 37.0, 39.0, 41.0, 43.0, 45.0, 47.0, 49.0, 51.0, 53.0, 55.0,
        ...
        if self.debug:
            for part in [self.config.lawn, self.config.sprinkler_head,
                         self.config.angles.horizontal, self.config.angles.vertical,
                         self.config.hose, self.config.motors]:
                print(json.dumps(part, indent=2, default=str))
